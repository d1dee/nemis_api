...
let searchLearnerSchema = zod
	.object({
		xcat: zod.string().optional(),
		xcatdesc: zod.string().optional(),
		upi: zod.string().optional(),
		names: zod.coerce.string().transform(x => x.replaceAll(',', '')),
		surname: zod.string().optional(),
		firstname: zod.string().optional(),
		othernames: zod.string().optional(),
		institution_name: zod.string().optional(),
		phone_number: zod.string().optional(),
		email_address: zod.string().optional(),
		postal_address: zod.string().optional(),
		father_upi: zod.string().optional(),
		mother_upi: zod.string().optional(),
		guardian_upi: zod.string().optional(),
		father_name: zod.string().optional(),
		father_idno: zod.string().optional(),
		father_contacts: zod.string().optional(),
		mother_name: zod.string().optional(),
		mother_idno: zod.string().optional(),
		mother_contacts: zod.string().optional(),
		guardian_contacts: zod.string().optional(),
		guardian_idno: zod.string().optional(),
		guardian_name: zod.string().optional(),
		special_medical_condition: zod.string().optional(),
		any_special_medical_condition: zod.string().optional(),
		institution_code: zod.string().optional(),
		sub_county_code: zod.string().optional(),
		nationality: zod.string().optional(),
		gender: zod.string().optional(),
		lgender: zod.string().optional(),
		dob2: zod.string().optional(),
		birth_cert_no: zod.string().optional(),
		id_no: zod.string().optional(),
		disability_code: zod.string().optional(),
		class_code: zod.string().optional(),
		county_code: zod.string().optional(),
		county_learner: zod.string().optional(),
		sub_county_learner: zod.string().optional(),
		special_needs_list: zod.string().optional(),
		father_email: zod.string().optional(),
		mother_email: zod.string().optional(),
		guardian_email: zod.string().optional(),
		institution_type: zod.string().optional(),
		institution_level_code: zod.string().optional(),
		nhif_no: zod.string().optional(),
		class_name: zod.string().optional(),
		level_name: zod.string().optional()
	})
	.transform(res => ({
		name: res.names,
		dob: res.dob2,
