...
// Returns a UTC date and a string representation to Africa/Nairobi timezone

export const dateTime = function (date?: Date) {
    if (date instanceof Date) {
        return {
            UTCTimestamp: date,
            formattedDate: formatInTimeZone(date, 'Africa/Nairobi', 'yyyy-MM-dd HH:mm:ss zzz'),
