...
import SendResponse from './src/controller/utils/send_response';
...
app_init()
    .then(_ => {
        ...
        app.use(
            ...
            (err: any, req: Request, _: Response, next: NextFunction) => sendErrorMessage(req, err, next)
        );
        ...
        //@todo Send API documentation on this route
